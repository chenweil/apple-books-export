...
- [ ] **Step 12: Create minimal `src/App.svelte`**
...
- [ ] **Step 13: Create `src/lib/Sidebar.svelte`**
...
- [ ] **Step 16: Create `src-tauri/src/lib.rs` (empty placeholder)**
...
- [ ] **Step 17: Create `src-tauri/src/state.rs` (empty placeholder)**

```rust
// Managed state will be added in Task 2
```

- [ ] **Step 18: Create `src-tauri/src/commands.rs` (empty placeholder)**

```rust
// Tauri commands will be added in Task 2
```

- [ ] **Step 19: Verify it builds**
...
- [ ] **Step 1: Add existing source as local dependency**
...
- [ ] **Step 4: Update `src-tauri/src/lib.rs` to register commands and state**
...
- [ ] **Step 1: Create `src/lib/components/LoadingSpinner.svelte`**
...
- [ ] **Step 2: Create `src/lib/components/PermissionDialog.svelte`**
...
- [ ] **Step 3: Create `src/lib/components/BookCard.svelte`**
...
- [ ] **Step 4: Create `src/lib/pages/Books.svelte`**
...
- [ ] **Step 5: Update `src/App.svelte` with permission check and page routing**
...
- [ ] **Step 1: Create `src/lib/components/ProgressBar.svelte`**
...
- [ ] **Step 2: Create `src/lib/pages/Export.svelte`**
...
- [ ] **Step 3: Create `src/lib/pages/Config.svelte`**
...
- [ ] **Step 4: Update `src/App.svelte` — add Export and Config pages to router**
...
- [ ] **Step 2: Create `src/lib/components/ConfirmDialog.svelte`**
...
- [ ] **Step 3: Create `src/lib/pages/Enrich.svelte`**
...
- [ ] **Step 4: Create `src/lib/pages/Cache.svelte`**
...
- [ ] **Step 5: Create `src/lib/pages/Card.svelte`**
...
- [ ] **Step 6: Update `src/App.svelte` — add remaining pages**
...
- [ ] **Step 1: Create `src/lib/StatusBar.svelte`**
...
- [ ] **Step 2: Update `src/App.svelte` — add StatusBar**
